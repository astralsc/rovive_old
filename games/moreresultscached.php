...
// Create another instance but use the job class
$jobClass = new Jobs;
...
?>
    <li class="list-item game-card">
        <div class=game-card-container> <a href="/games/<?= $game['id'] ?>/" class=game-card-link>
                ...
                <div class=game-card-name-secondary><?= $playerAmount ?> Playing</div>
                <div class=game-card-vote>
                    <div class=vote-bar data-voting-processed=false>
                        ...
                        <div class=vote-container data-upvotes=100 data-downvotes=0>
